...
export const triageResultSchema = z.object({
  ...
  fraud_flags: z.array(z.string()).describe("List of any potential fraud indicators, or an empty array if none."),
});
...
export const settlementRecommendationSchema = z.object({
  ...
  next_steps: z.string().describe("The recommended next steps for the human adjuster."),
});
